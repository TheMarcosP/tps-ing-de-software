...
public class UnoControllerTest {
    ...
    @Test
    public void testCanCreateNewMatchWithValidPlayers() throws Exception {
        assertEquals(7, getPlayerHand(getNewMarkAndSeguMatch()).size());
    }

    @Test
    public void testCanNotCreateNewMatchWithNotEnoughPlayers() throws Exception {
        assertEquals(Match.NotEnoughPlayers, performErrorRequest(createNewMatch(Mark)));
    }

    @Test
    public void testCanPlayCard() throws Exception {
        performSuccessRequest(playCard(getNewMarkAndSeguMatch(), Mark, playableCard));
    }

    @Test
    public void testCanNotPlayCardMatchIDNotFound() throws Exception {
        UUID matchID = UUID.randomUUID();
        assertMatchNotFoundError(matchID, playCard(matchID, Mark, playableCard));
    }

    @Test
    public void testCanNotPlayCardNotPlayersTurn() throws Exception {
    ...
    @Test
    public void testCanNotPlayCardNotACardInHand() throws Exception {
        assertPlayCardError(Match.NotACardInHand + Mark, unplayableCardNotInHand);
    }

    @Test
    public void testCanNotPlayCardCardDoNotMatch() throws Exception {
        assertPlayCardError(Match.CardDoNotMatch, unplayableCardDoNotMatch);
    }

    @Test
    public void testCanNotPlayCardInvalidJson() throws Exception {
    ...
    @Test
    public void testCanNotDrawCardMatchIDNotFound() throws Exception {
        UUID matchID = UUID.randomUUID();
        assertMatchNotFoundError(matchID, drawCard(matchID, Mark));
    }

    @Test
    public void testCanNotDrawCardNotPlayersTurn() throws Exception {
        UUID matchID = getNewMarkAndSeguMatch();
    ...
    @Test
    public void testCanGetActiveCard() throws Exception {
    ...
    @Test
    public void testCanNotGetActiveCardMatchIDNotFound() throws Exception {
        UUID matchID = UUID.randomUUID();
        assertMatchNotFoundError(matchID, getActiveCard(matchID));
    }

    @Test
    public void testCanGetPlayerHand() throws Exception {
    ...
    @Test
    public void testCanGetOtherPlayerHand() throws Exception {
        UUID matchID = getNewMarkAndSeguMatch();
    ...
    @Test
    public void testCanNotGetPlayerHandMatchIDNotFound() throws Exception {
        UUID matchID = UUID.randomUUID();
    ...
    private String performErrorRequest(ResultActions action) throws Exception {
        return action.andExpect(status().is5xxServerError())
                .andReturn().getResponse().getContentAsString();
    }
    ...
    private List<Card> getPlayerHand(UUID matchID) throws Exception {
        ...
        return new ObjectMapper().readValue(response, new TypeReference<List<JsonCard>>(){})
                .stream()
                .map(JsonCard::asCard)
