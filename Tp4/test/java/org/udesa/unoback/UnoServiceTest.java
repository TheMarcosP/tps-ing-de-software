...
public class UnoServiceTest {
    ...
    @Test public void testCanCreateNewMatches() {
    ...
    @Test public void testCanPlayTwoMatches() {
        UUID matchID1 = createMatch();
        UUID matchID2 = createMatch();
    ...
    @Test public void testCanNotPlayMatchIDNotFound() {
    ...
    @Test public void testCanNotDrawCardMatchIDNotFound() {
        UUID nonExistentMatchID = UUID.randomUUID();
        assertMatchNotFoundError(() -> unoService.drawCard(nonExistentMatchID, Mark), nonExistentMatchID);
    }

    @Test public void testCanGetActiveCardInTwoMatches() {
        UUID matchID1 = createMatch();
        UUID matchID2 = createMatch();
    ...
    @Test public void testCanNotGetActiveCardMatchIDNotFound() {
        UUID nonExistentMatchID = UUID.randomUUID();
        assertMatchNotFoundError(() -> unoService.activeCard(nonExistentMatchID), nonExistentMatchID);
    }

    @Test public void testCanGetPlayerHandInTwoMatches() {
        UUID matchID1 = createMatch();
        UUID matchID2 = createMatch();
    ...
    @Test public void testPlayCardTest() {
        UUID matchID = createMatch();
